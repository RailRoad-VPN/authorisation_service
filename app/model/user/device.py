...
class UserDevice(object):
    ...
    def __init__(self, suuid: str = None, user_uuid: str = None, pin_code: int = None, device_token: str = None,
                 device_name: str = None, location: str = None, is_active: bool = None, modify_reason: str = None,
...
class UserDeviceStored(StoredObject, UserDevice):
    ...
    def __init__(self, storage_service: StorageService, suuid: str = None, user_uuid: str = None, pin_code: int = None,
                 device_token: str = None, device_name: str = None, location: str = None, is_active: bool = None,
        ...
        UserDevice.__init__(self, suuid=suuid, user_uuid=user_uuid, pin_code=pin_code, device_token=device_token,
                            device_name=device_name, location=location, is_active=is_active,
...
class UserDeviceDB(UserDeviceStored):
    ...
    _device_name_field = 'device_name'
    ...
    def create(self) -> str:
        ...
        try:
            ...
            self._storage_service.create(create_user_device_sql, create_user_device_params)
    ...
    def find_by_suuid(self) -> Optional[UserDevice]:
        ...
        return self.__map_user_devicedb_to_user_device(user_device_db)
    ...
    def find_all(self) -> Optional[List[UserDevice]]:
        ...
        for user_device_db in user_device_db_list:
            user_device = self.__map_user_devicedb_to_user_device(user_device_db)
    ...
    def __map_user_devicedb_to_user_device(self, user_device_db):
        return UserDevice(suuid=user_device_db[self._suuid_field], user_uuid=user_device_db[self._user_uuid_field],
                          ...
                          device_name=user_device_db[self._device_name_field],
