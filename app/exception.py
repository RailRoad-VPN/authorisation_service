...
class AuthError(APIErrorEnum):
    ...
    USER_DEVICE_FINDBYDEVICEID_ERROR_DB = (name + str(count()), 'USER_DEVICE_FINDBYDEVICEID_ERROR_DB phrase', 'USER_DEVICE_FINDBYDEVICEID_ERROR_DB description')
    USER_DEVICE_FINDBYDEVICEID_ERROR = (name + str(count()), 'USER_DEVICE_FINDBYDEVICEID_ERROR phrase', 'USER_DEVICE_FINDBYDEVICEID_ERROR description')
    ...
    USER_VPNSERVERCONFIG_FIND_BY_UUID_ERROR = (name + str(count()), 'USER_VPNSERVERCONFIG_FIND_BY_UUID_ERROR phrase', 'USER_VPNSERVERCONFIG_FIND_BY_UUID_ERROR description')
    USER_VPNSERVERCONFIG_FIND_BY_USER_PLATFORM_TYPE_ERROR_DB = (name + str(count()), 'USER_VPNSERVERCONFIG_FIND_BY_USER_PLATFORM_TYPE_ERROR_DB phrase', 'USER_VPNSERVERCONFIG_FIND_BY_USER_PLATFORM_TYPE_ERROR_DB description')
    USER_VPNSERVERCONFIG_FIND_BY_USER_PLATFORM_TYPE_ERROR = (name + str(count()), 'USER_VPNSERVERCONFIG_FIND_BY_USER_PLATFORM_TYPE_ERROR phrase', 'USER_VPNSERVERCONFIG_FIND_BY_USER_PLATFORM_TYPE_ERROR description')
    USER_VPNSERVER_CREATE_ERROR_DB = (name + str(count()), 'USER_VPNSERVER_CREATE_ERROR_DB phrase', 'USER_VPNSERVER_CREATE_ERROR_DB description')
    USER_VPNSERVERCONFIG_UPDATE_ERROR_DB = (name + str(count()), 'USER_VPNSERVERCONFIG_UPDATE_ERROR_DB phrase', 'USER_VPNSERVERCONFIG_UPDATE_ERROR_DB description')
